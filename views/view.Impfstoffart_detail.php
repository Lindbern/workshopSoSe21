...
$klasse->render("m_ts");
$klasse->renderLabel("ImpfstoffBez");
$klasse->render("ImpfstoffBez");
...
<div id="view_Impfstoff_b">
<?php
Core::$view->render("view_Impfstoff_b");
?>
<form method="post" action="?task=Impfstoffart_handle_Impfstoff_b&id=<?=$klasse->id?>" data-ajax="false">
