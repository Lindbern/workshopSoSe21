...
Impftermin (1..1) ---- (*..*) Impfstoff <br><br>
<h4>Bedeutet für diese Seite der Beziehung:</h4>
<p>Das Objekt in dieser Detailansicht (aus der Klasse: Impftermin) kann mehrere Verbindungen zu Objekten der Partnerklasse (Impfstoff) haben (*..*).</p><br>
...
<?php $Impfstoff_a->renderHeader("_Impftermin", "table"); ?>
...
<td>
<a href="?task=Impftermin_delete_Impfstoff_a&id=<?=$klasse->id?>&back=<?=$Impftermin->id?>&muss=false" data-ajax="false" data-role="button"  class="ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all ui-btn-inline">delete</a>
</td>
</td>
</tr>
<?php }
