...
Impftermin (*..*) ---- (1..1) Arzt <br><br>
<h4>Bedeutet für diese Seite der Beziehung:</h4>
<p>Das Objekt in dieser Detailansicht (aus der Klasse: Impftermin) muss genau eine Verbindung zu einem Objekt der Partnerklasse (Arzt) haben (1..1).</p><br>
...
$klasse->renderLabel("Email", "detail");
$klasse->render("Email", "detail");
