...
<a href="?task=Impfstoffart_detail&id=<?=$id?>" class="ui-btn ui-icon-back ui-btn-icon-notext ui-corner-all" data-ajax="false">No text</a>
</div>
...
<td>
<form method="post" action="?task=Impfstoffart_handle_Impfstoff_b&id=<?=$id?>" data-ajax="false">
